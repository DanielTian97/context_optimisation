...
python ./sentence_reranking_test.py mt5 dl_20 s-reranked_position-1 3
echo 'Finished generation for 3shot for trec-dl-20 integrated-rp-1 mt5!'
python ./sentence_reranking_test.py mt5 dl_20 s-reranked_position-3 3
echo 'Finished generation for 3shot for trec-dl-20 integrated-rp-3 mt5!'
...
python ./sentence_reranking_test.py mt5 dl_20 s-reranked_position-1 5
echo 'Finished generation for 5shot for trec-dl-20 integrated-rp-1 mt5!'
python ./sentence_reranking_test.py mt5 dl_20 s-reranked_position-3 5
echo 'Finished generation for 5shot for trec-dl-20 integrated-rp-3 mt5!'
...
python ./sentence_reranking_test.py mt5 dl_20 s-reranked_position-1 7
echo 'Finished generation for 7shot for trec-dl-20 integrated-rp-1 mt5!'
python ./sentence_reranking_test.py mt5 dl_20 s-reranked_position-3 7
echo 'Finished generation for 7shot for trec-dl-20 integrated-rp-3 mt5!'
...
python ./sentence_reranking_test.py mt5 dl_20 s-reranked_position-1 10
echo 'Finished generation for 10shot for trec-dl-20 integrated-rp-1 mt5!'
